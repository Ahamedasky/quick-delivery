...
document.getElementById("search-input").addEventListener("input", function () {
  ...
  const transliterations = {
    "வாழைக்காய்": ["vaazhaikkai", "vazhaikkai", "valaikkai"],
    "கத்தரிக்காய்": ["katharikkai", "kattarikkai", "kaththarikkai"],
    "வெண்டைக்காய்": ["vendakkai", "vendai", "vendekai", "vandakai"],
    "பயற்றங்காய்": ["payathankai", "payatrangai", "payarangai"],
    "லீக்ஸ்": ["leeks", "leaks"],
    "பீட்ரூட்": ["beetroot", "beetrood", "peedroot"],
    "பச்சை கொச்சிக்காய்": ["pachai kochikkai", "pachai kochikai", "pachai kochikay"],
    "சின்ன வெங்காயம்": ["chinna vengayam", "sinna vengayam", "small onion"],
